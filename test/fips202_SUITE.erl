...
fips202([
	...
	?tv_ok(T0, libdecaf_shake, hash, [Type, InputBytes], MD),
	Sponge0 = libdecaf_shake:init(Type),
	Sponge1 = libdecaf_shake:update(Sponge0, InputBytes),
	?tv_ok(T1, libdecaf_shake, final, [Sponge1], MD),
...
fips202([
	...
	InputBytes = binary:part(Msg, 0, Len div 8),
	?tv_ok(T0, libdecaf_shake, hash, [Type, InputBytes, OutputByteLen], Squeezed),
	Sponge0 = libdecaf_shake:init(Type),
	Sponge1 = libdecaf_shake:update(Sponge0, InputBytes),
	?tv_ok(T1, libdecaf_shake, final, [Sponge1, OutputByteLen], Squeezed),
	fips202(Vectors, {Type, Arity, OutputByteLen}, Config);
fips202([
			{vector, {<<"Len">>, _Len}, _},
			{vector, {<<"Msg">>, _Msg}, _},
